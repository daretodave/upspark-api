...
const validate = (type, email, content, payload, image) => {
    ...
    if (image && typeof image !== 'string') {
        ...
        if (length > 10000000) {
            error("feedback.image is over 10 mb", 42);
        }
    }
...
const types = {
    "bug": {
        ...
        "contents": [
            "Hi there! ",
            "",
            "Thanks for your recent bug report. This is an automatic email just to let you know that we received your submission successfully. We'll do our best to look at this bug as soon as we can.",
            "",
            "In the meanwhile, if you had any additional info or questions simply reply to this email.",
            "",
            "Thanks again!",
            "",
            "--",
    ...
    "suggestion": {
        ...
        "contents": [
            "Hi there! ",
            "",
            "Thanks for your recent suggestion. This is an automatic email just to let you know that we received your submission successfully. We'll do our best to look at this suggestion as soon as we can.",
            "",
            "In the meanwhile, if you had any additional info or questions simply reply to this email.",
            "",
            "Thanks again!",
    ...
    "kuddos": {
        "title": "Kuddos",
        "sender": "feedback@upspark.io",
        "subject": "Appreciate the love!",
        "contents": [
            "Hi there! ",
            "",
            "Thanks for your recent kuddos! This is an automatic email just to let you know that we received your feedback successfully. ",
            "",
            "We value feedback tremendously and will do our best to look this over as soon as possible.",
            "",
